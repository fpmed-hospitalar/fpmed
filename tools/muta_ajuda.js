...
const MUTS = [
  ...
  // ══ FATIA B18 — AS MUTACOES DO "O GUIA CONTINUA VERDADEIRO" ═══════════════════════════════
  // As de cima cobram que o guia nao PERCA o que ele promete. Estas cobram a outra metade, que
  // e a da B18: que ele nao DESCREVA uma tela que nao existe. A primeira e o defeito de verdade
  // que a B18 achou — a aba "historico", que o guia da B11 citava e que ficha nenhuma tem.
  ['*** o guia volta a citar uma aba que NAO EXISTE na ficha ***',
    '<b>Informações</b>, <b>Itens</b>,',
    '<b>Informações</b>, <b>Itens</b>, <b>histórico</b>,'],
  ['*** uma aba que existe na ficha some do guia ***',
    '<b>Credenciamentos</b> e <b>Observações</b>',
    'e <b>Observações</b>'],
  ['*** uma das seis gavetas de "Meus arquivos" some ***',
    '<b>Edital e anexos</b>, <b>Proposta</b>,',
    '<b>Proposta</b>,'],
  ['a contagem das gavetas deixa de bater com a tela',
    'em <b>seis gavetas</b>',
    'em <b>cinco gavetas</b>'],
  ['*** a etiqueta de procedencia "anexado a mao" some ***',
    '<span class="bt">anexado à mão</span>',
    '<span class="bt">nosso</span>'],
  ['*** o guia deixa de dizer que a versao antiga NAO se apaga ***',
    '<span class="bt">versão anterior — nada se apaga</span>',
    '<span class="bt">substituída</span>'],
  ['*** "Conferir nao grava nada" vira o contrario ***',
    '<b>Conferir não grava nada</b>',
    '<b>Conferir já grava o número</b>'],
  ['*** o guia deixa de dizer que gravar so nasce quando o servidor deixa ***',
    'só aparece quando o portal disser que pode',
    'aparece logo em seguida'],
  ['*** o selo "Sem valor de referencia" some do guia ***',
    '<span class="bt">Sem valor de referência</span>',
    '<span class="bt">Sem preço</span>'],
  ['*** a distincao entre "sem referencia" e "R$ 0,00" vira o CONTRARIO ***',
    '<b>“Sem referência” não é o mesmo que “R$ 0,00”.</b>',
    '<b>“Sem referência” quer dizer R$ 0,00.</b>'],
  ['*** "sem EAN cadastrado" some da Proposta no guia ***',
    '<span class="bt">sem EAN cadastrado</span>',
    '<span class="bt">produto sem código</span>'],
  ['*** o guia passa a PROMETER o EAN no documento impresso (que nao esta la) ***',
    'hoje eles não vão no\n            documento impresso',
    'e eles também saem no\n            documento impresso'],
  ['*** um dos relatorios com IA da aba de Ata some do guia ***',
    '<span class="bt">O que eu ganhei</span>',
    '<span class="bt">Relatório</span>'],
  ['*** a regra do custo volta a valer so para o "Conversar com o edital" ***',
    '<b>Esta regra vale em todo lugar do sistema onde houver o selo de custo</b>',
    '<b>Esta regra vale para a pergunta ao edital</b>'],
  ['jargao entra no texto NOVO da B18 (a varredura pega o arquivo inteiro, nao so o velho)',
    'Gaveta vazia não aparece.',
    'Gaveta vazia não aparece (a tela guarda a lista em cache).'],
];
