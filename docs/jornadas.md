...
|---|---|---|---|
| 1 | Achar licitação → funil | 🔴 → **🟡 em 13/08** | **AS DUAS METADES DO VERMELHO CAÍRAM, e a nota subiu um degrau — não dois.** A primeira caiu em 12/08: a nota dizia "a coleta parou, licitação mais nova de 06/08, 142h atrás", e aquilo saiu de uma prova que media a tabela ERRADA (`licitacoes_acompanhadas`, histórico de participação, no lugar de `licitacoes`, o índice). Remedido: **3.197 linhas, última coleta 12,5h atrás**, e o motor do alarme diz "sem alarme". A segunda era o visual reprovado pelo dono ("ainda um pouco amador") — e **os 6 passos do molde fecharam na Encontrar em 13/08** (tokens · sidebar navy · header sticky · 4 indicadores ligados no banco · barra de busca com chips · painel de resultados), com os números provados contra o banco (`tools/prova_indicadores.js`) e o layout medido nas 4 larguras. **Em 13/08 o item 7d fechou a última lista fora do molde:** a busca nacional do PNCP era tabela crua de seis colunas embaixo do painel novo, e virou o mesmo painel com as mesmas linhas — provada com dado real (3.657 resultados de "albumina"), 35 asserts novos e mutação 22/22. Junto veio o `fpmed_icones.js`, sprite de fonte única, que matou uma cópia de ícone que **já tinha divergido meio pixel** entre as duas telas. **Em 13/08 o item 7e deu à busca a terceira fonte:** os pregões do Calendário 2025 (2.555 linhas que só viviam no funil) passaram a ser encontrados, com a origem declarada em cada painel — "nosso índice do PNCP" · "do seu Calendário 2025" · "ao vivo · PNCP". 27 asserts novos, mutação 20/20. E o assert de cobertura, repontado nessa passagem, achou um defeito que estava no ar desde que o Radar nasceu: ele contava licitação por cidade sobre **1.000 de 3.201 linhas**, e o aviso de honestidade da própria tela imprimia "1000 coletadas", escondendo o erro. **Por que continua amarela, e são três coisas concretas:** (a) a tela nunca foi percorrida com **sessão real** — o laço injeta dado e remove o portão de login, o que prova layout e lógica, não a jornada; a sessão deste navegador está expirada (401 medido) e eu não faço login; (b) a **outra metade da jornada é o Negócios**, que está sendo molde-ficado em outra frente (item 7b) e ainda não fechou; (c) ~~sobram 51 emoji-ícone~~ **— caiu em 13/08 com o item 7f: os 36 que restavam viraram `<use>` do sprite, e o fio dobrado que o Trabalhador B achou no Negócios foi conferido e consertado aqui também (0,8px na junção, não 1,6).** Sobram as **17 setas tipográficas**, que ficam por fronteira declarada. Então a jornada 1 está a **um item** do verde: falta percorrê-la com sessão real. |
