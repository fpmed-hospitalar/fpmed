...
|---|---|---|---|
| 1 | Achar licitação → funil | 🔴 | **METADE DO MOTIVO CAIU EM 12/08, e a outra metade sustenta o vermelho sozinha.** O que caiu: a nota dizia "a coleta parou, licitação mais nova de 06/08, 142h atrás" — aquilo saiu de uma prova que media a tabela ERRADA (`licitacoes_acompanhadas`, que é histórico de participação, no lugar de `licitacoes`, que é o índice). Remedido agora, com `node tools/prova_automacoes_vivas.js`: **3.197 linhas, última coleta 12,5h atrás, publicação mais nova de 12/08**, e o motor do alarme — o mesmo do sino — diz "sem alarme". A matéria-prima está chegando. O que **continua** vermelho: o visual reprovado pelo dono ("ainda um pouco amador"), que é o item 7 da fila, com amostra aprovada como alvo. |
